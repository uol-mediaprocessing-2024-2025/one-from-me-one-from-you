...
const componentName = "hexagonComponent";
...
.grid-item:nth-child(7) { top: 70%; left: 50%; }

.grid-item:nth-child(8) { top: 65%; left: 40%; }
...
.grid-item:nth-child(14) { top: 65%; left: 60%; }
.grid-item:nth-child(15) { top: 15%; left: 60%; }
.grid-item:nth-child(16) { top: 25%; left: 60%; }
.grid-item:nth-child(17) { top: 35%; left: 60%; }
.grid-item:nth-child(18) { top: 45%; left: 60%; }
.grid-item:nth-child(19) { top: 55%; left: 60%; }

.grid-item:nth-child(20) { top: 60%; left: 30%; }
.grid-item:nth-child(21) { top: 20%; left: 30%; }
.grid-item:nth-child(22) { top: 30%; left: 30%; }
.grid-item:nth-child(23) { top: 40%; left: 30%; }
.grid-item:nth-child(24) { top: 50%; left: 30%; }

.grid-item:nth-child(25) { top: 60%; left: 70%; }
.grid-item:nth-child(26) { top: 20%; left: 70%; }
.grid-item:nth-child(27) { top: 30%; left: 70%; }
.grid-item:nth-child(28) { top: 40%; left: 70%; }
.grid-item:nth-child(29) { top: 50%; left: 70%; }

.grid-item:nth-child(30) { top: 30%; left: 80%; }
.grid-item:nth-child(31) { top: 40%; left: 80%; }
.grid-item:nth-child(32) { top: 50%; left: 80%; }

.grid-item:nth-child(33) { top: 30%; left: 20%; }
.grid-item:nth-child(34) { top: 40%; left: 20%; }
.grid-item:nth-child(35) { top: 50%; left: 20%; }
